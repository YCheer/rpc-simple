package fun.lzyan.component.extension;
...
public final class ExtensionLoader<T> {
    ...
    /**
     * 读取文件内容，提取每行内容 gzip=fun.lzyan.component.compress.gzip.GzipCompress
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.length() > 0) {
                    try {
                        ...
                        // gzip=fun.lzyan.component.compress.gzip.GzipCompress
                        // 截取 = 前面的
